            ...
            <div className="flex-1 overflow-y-auto space-y-2 pr-1">
              {loadingChars ? (
                ...
                filteredCharacters.map((char) => (
                  ...
                  >
                    <img
                      src={char.image_url || `https://api.dicebear.com/9.0/bottts-neutral/svg?seed=${char.name}`}
                      alt={char.name}
          ...
          <div className="lg:col-span-3 bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl flex flex-col overflow-hidden">
            {selectedCharacter ? (
              <>
                ...
                <div className="bg-gradient-to-r from-purple-900/40 to-pink-900/40 border-b border-gray-800 p-4 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <img
                      src={selectedCharacter.image_url || `https://api.dicebear.com/9.0/bottts-neutral/svg?seed=${selectedCharacter.name}`}
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {messages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center">
                      ...
                      <p className="text-gray-500 text-sm mt-2">Type a message below</p>
                    </div>
                  ) : (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                <div className="w-24 h-24 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center mb-6">
