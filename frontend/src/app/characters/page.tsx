...
import { Search, Zap, Brain, Star, Shield, CheckCircle } from "lucide-react";
  ...
  const fetchCharacters = async () => {
    ...
    try {
      ...
      if (selectedUniverse) {
        ...
        url = `${process.env.NEXT_PUBLIC_API_URL}/api/characters/search?q=${searchQuery}`;
      } else {
        url = `${process.env.NEXT_PUBLIC_API_URL}/api/characters/search?q=a`;
      }
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          ...
          {fromCache && (
            <div className="inline-flex items-center gap-2 mt-2 px-3 py-1 bg-green-900/30 border border-green-500/30 rounded-full">
              ...
              <span className="text-xs text-green-400 font-semibold">⚡ Cached Data (Instant)</span>
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="flex-1 relative">
            ...
            <input
              ...
              onKeyDown={(e) => e.key === 'Enter' && fetchCharacters()}
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-purple-400 font-bold animate-pulse">Loading from cache...</p>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {characters.map((char) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-white mb-1 truncate">{char.name}</h3>
